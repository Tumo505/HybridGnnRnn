#!/usr/bin/env python3
"""
Enhanced Temporal RNN Training Script

Train the EnhancedTemporalRNN model on real cardiac temporal data
with comprehensive regularization and evaluation.

Features:
- Real cardiac temporal data loading
- Advanced RNN architecture with attention
...
def train_enhanced_temporal_rnn():
    """
    Main training function for Enhanced Temporal RNN.
    """
    ...
    # 5. Initialize Enhanced Temporal RNN model
    print("\\n5. Initializing Enhanced Temporal RNN...")
    ...
    print(f"   Architecture: Bidirectional LSTM + Attention + Multi-scale Conv")
    print(f"   Temporal convolutions: {[64, 128, 256]} filters")
    print(f"   Cardiac pattern detection: Enabled")
    
    # 6. Setup training with advanced techniques
    print("\\n6. Setting up enhanced training...")
    ...
    best_val_acc = 0
    patience = 7  # More patience for complex model
    patience_counter = 0
    best_model_state = None
    
    # 7. Training loop with enhanced features
    print("\\n7. Training Enhanced Temporal RNN...")
    ...
    for epoch in range(num_epochs):
        ...
        for batch_idx, (data, target) in enumerate(pbar):
            ...
            # Add sequence dimension for RNN (batch_size, seq_len=1, features)
    ...
    print("\\n" + "="*70)
    print("🎯 ENHANCED TEMPORAL RNN RESULTS")
    print("="*70)
    ...
    print(f"Architecture: Enhanced Temporal RNN with Attention + Multi-scale Conv")
    ...
    results['architecture'] = "Enhanced Temporal RNN with Attention + Multi-scale Convolutions"
    
    # Save model and results
    model_path = "enhanced_temporal_rnn.pth"
    results_path = "enhanced_temporal_rnn_results.json"
...
if __name__ == "__main__":
    model, results = train_enhanced_temporal_rnn()