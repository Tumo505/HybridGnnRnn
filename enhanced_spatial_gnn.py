...
class EnhancedSpatialGNN(nn.Module):
    ...
    def __init__(self,
        ...
        # Advanced classification head for node-level predictions
    ...
    def forward(self, data: Data, return_embeddings: bool = False):
        """Enhanced forward pass with node-level predictions"""
        ...
        # Node-level predictions (instead of global pooling)
        classification_logits = self.classifier(node_embeddings)
        regression_pred = self.regressor(node_embeddings)
